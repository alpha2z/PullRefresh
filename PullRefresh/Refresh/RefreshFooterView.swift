...
class RefreshFooterView: RefreshBaseView {
    class func footer()->RefreshFooterView{
        var footer:RefreshFooterView  = RefreshFooterView(frame: CGRectMake(0, 0, UIScreen.mainScreen().bounds.width, CGFloat(RefreshViewHeight)))
        return footer
    }
    ...
    //override func observeValueForKeyPath(keyPath: String!, ofObject object: AnyObject!, change: NSDictionary!, context: UnsafeMutablePointer<Void>) {
